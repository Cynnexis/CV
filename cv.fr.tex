...
\header{Ingénieur Informatique\\spécialisé en Intelligence Artificielle}
	...
	\work{Expériences Professionnelles}{
		...
		\entrydescription{
			...
			\begin{itemize}
				...
				\item Utilisation de réseau de neurones avec TensorFlow.
			\end{itemize}
		}
	...
	\skills{Compétences}{
		...
		\entrydescription{
			\begin{itemize}
				...
				\item Bonne maîtrise d'Android Natif et TensorFlow
				\item Maîtrise élémentaire de Qt (Framework C++), VueJS et Flutter
			\end{itemize}
		}
	}
