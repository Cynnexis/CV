...
\mainpanel{
	...
	\work{Expériences Professionnelles}{
		...
		\entrydescription{
			...
			La mission était de manipuler une formulation d'un modèle mathématique sur une raffinerie de façon à gérer les arrêts non-anticipés des machines, avec différentes durée d'arrêt.
